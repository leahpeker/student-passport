...
SYSTEM = (
    ...
    '"most Mondays".\n'
    '- Write in full sentences a person would actually say out loud. No sentence '
    'fragments, no "X, not Y" rhetorical parallelism, no dash standing in for a '
    'verb. If it reads like a tagline, rewrite it as a sentence.\n'
    '- No AI-report language: "leverage", "underscore", "highlight", "holistic", '
    '"landscape", "journey", "unpack", "dive into", "robust", "seamless", '
    '"testament to". If a sentence needs one of these to sound important, cut '
    'the padding instead.\n'
